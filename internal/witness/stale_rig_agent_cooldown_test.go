...
func TestDetectStaleRigAgentHeartbeats_CooldownSuppressesSecondCycle(t *testing.T) {
	...
	res1 := DetectStaleRigAgentHeartbeats(townRoot, rigName, nil, time.Hour, "", 30*time.Minute, 0, nil)
	...
	res2 := DetectStaleRigAgentHeartbeats(townRoot, rigName, nil, time.Hour, "", 30*time.Minute, 0, nil)
