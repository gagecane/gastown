...
// open-coded, and a typo silently no-ops. This package centralises the
// protocol:
//
//   - Every recognised GT_* var is declared once, as a typed [Var] constant.
...
// registry is the authoritative inventory of recognised GT_* vars. Keyed by
...
// polecats decide per-site whether the new convention preserves behaviour;
