// Package beads — write operations against the bd CLI.
//
// This file owns all mutation methods on *Beads: Create, Update, Close
// (in all its variants), Release, and dependency add/remove. Read operations
// live in beads_read.go.
package beads
