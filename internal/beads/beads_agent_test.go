...
// TestUpdate_RigPrefixedAgentBeadUsesTownRoot verifies that Beads.Update routes
// a rig-prefixed, town-owned agent bead to the town database rather than the rig
// database the prefix would otherwise map to (gu-cjprh / upstream PR #3978).
