// Package beads — read operations against the bd CLI.
//
// This file owns all methods on *Beads that only read: List, Show, Ready,
// Blocked, Search, and the various list/ready variants. Writing operations
// (Create/Update/Close/dep) live in beads_write.go.
package beads
