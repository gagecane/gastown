// Package beads — PRIME.md provisioning for worker contexts.
//
// This file owns the embedded PRIME.md content shipped with Gas Town and the
// idempotent helpers that write it into a beads directory (used as a fallback
// when the SessionStart hook fails to deliver context).
package beads
