...
//
// commit_guard_test.go and lifecycle_test.go both push to origin in their
// fixtures — without this init a pre-push-hook run would route those
// pushes onto the real repo.
func init() {
