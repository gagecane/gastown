...
// This file contains the catch-all maintenance steps the heartbeat runs
// once per tick: orphan-process cleanup (leaked Claude subagents),
// stale-branch pruning in every rig clone, and the scheduler-dispatch
// shell-out. None of these target a specific agent role — they are
// "house-keeping" for the whole town.
