...
// Rig discovery and operational status: helpers that answer "which rigs
// are registered?" and "is this rig eligible for agent spawning?" The
// per-tick cache lives on Daemon; callers invoke invalidateKnownRigsCache
// at the top of each heartbeat to refresh from disk.
