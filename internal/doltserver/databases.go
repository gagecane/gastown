// databases.go: Database listing, verification, and DSN construction.
// Queries SHOW DATABASES, caches results, and distinguishes user databases
// from Dolt system tables.
