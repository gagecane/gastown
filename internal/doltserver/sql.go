// sql.go: Low-level SQL execution helpers for communicating with the running
// Dolt server via 'dolt sql' / 'dolt sql-client' subprocesses. Includes retry,
// catalog-wait, and script execution.
