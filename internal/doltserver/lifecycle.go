// lifecycle.go: Start, Stop, WaitForReady, and connection-draining helpers.
// The server lifecycle: starting the Dolt SQL server process, waiting for it
// to become ready, and stopping it cleanly.
