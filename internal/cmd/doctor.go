...
Dolt checks:
  ...
  - stale-embeddeddolt       Detect stale embeddeddolt/ directories (fixable)
...
func runDoctor(cmd *cobra.Command, args []string) error {
	...
	d.Register(doctor.NewDoltPortDataDirCheck())    // Check the live :port server serves .dolt-data (gs-2oij)
	...
	d.Register(doctor.NewGateScriptFreshAllRigsCheck())
