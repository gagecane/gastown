...
func TestUpdateAgentStateOnDone_ReviewOnlyDeferredClosesNotDefers(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			updateAgentStateOnDone(filepath.Join(townRoot, "gastown"), townRoot, ExitDeferred, "gt-leg-rev", false, false, "", "")
...
func TestUpdateAgentStateOnDone_NormalDeferredStillDefers(t *testing.T) {
	...
	updateAgentStateOnDone(filepath.Join(townRoot, "gastown"), townRoot, ExitDeferred, "gt-base-456", false, false, "", "")
